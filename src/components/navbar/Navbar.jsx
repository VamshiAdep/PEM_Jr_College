                    ...
                    <div className={`navbar-links ${isMenuOpen ? 'show' : ''}`}>
                        ...
                        <div className="nav-link" onMouseEnter={toggleAboutDropdown} onMouseLeave={toggleAboutDropdown}>
                            ...
                            {isAboutDropdownOpen && (
                                <div className="dropdown-menu">
                                    ...
                                    <a href="#facility" className="dropdown-item" onClick={closeMenu}>P.E.M. Initiatives</a>
                                    ...
                                    <a
                                        ...
                                        onClick={closeMenu}
                                    >
                                        School Broucher <FaDownload style={{ marginLeft: '6px' }} />
                                    </a>
                        ...
                        <div className="nav-link" onMouseEnter={toggleAddmissionDropdown} onMouseLeave={toggleAddmissionDropdown}>
                            ...
                            {isAddmissionDropdownOpen && (
                                <div className="dropdown-menu">
                                    <a href="#Addmissions" className="dropdown-item" onClick={closeMenu}>Admissions for School 2025-26</a>
                                    <a href="#Addmissions" className="dropdown-item" onClick={closeMenu}>Admissions for Jr College 2025-26</a>
                                    <a href="#Addmissions" className="dropdown-item" onClick={closeMenu}>Admissions for Degree College 2025-26</a>
                                </div>
                            )}
                        </div>
